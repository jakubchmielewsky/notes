...
function App() {
    ...
    useEffect(() => {
        ...
        htmlElement.classList.remove('font-inter', 'font-noto-serif', 'font-source-code-pro');
        if (font === 'Serif') {
                ...
                <Routes>
                    ...
                    >
                        ...
                        <Route
                            path="/archived"
                            element={
                                isMobile ? <Archived /> : <ArchivedDesktop />
                            }
                        >
                            <Route
                                path="note/:noteId"
                        ...
                        <Route
                            path="/tag"
                            element={isMobile ? <Tags /> : <TagsDesktop />}
                        >
                            <Route
                                path=":tagName"
                                element= {null}
                        ...
                        <Route
                            path="/settings"
                            element={
                                isMobile ? <Settings /> : <SettingsDesktop />
                            }
                        >
                            <Route
                        ...
                        <Route path="/newnote" element={isMobile? <NewNote /> : <NewNoteDesktop/>} />
                    </Route>
