...
import Note from "./pages/desktop/Note";
                ...
                <Route
                    ...
                    element={
                        <ProtectedRoute replace={false}>
                            {isMobile ? null : <DesktopDashboard />}
                        </ProtectedRoute>
                    }
                >
                    {/*nested routes*/}
                    <Route index element={<Navigate to="/dashboard/notes" />} />
                    <Route path="/dashboard/notes" element={<Notes />}>
                      <Route path="/dashboard/notes/:note" element={<Note />}/>
                    </Route>
                    <Route
