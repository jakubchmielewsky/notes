      ...
      <div className="max-w-[440px] bg-white rounded-12 border-1 border-custom-neutral-200 divide-y-1 divide-custom-neutral-200 dark:bg-custom-neutral-700 dark:border-custom-neutral-600 dark:divide-custom-neutral-600">
        ...
        <div className="flex px-200 py-200 gap-150">
          ...
          <div className="flex flex-col gap-[6px]">
            <h4 className="text-preset-3 font-bold text-custom-neutral-950 dark:text-white">
              {title}
            </h4>
            <p className="text-preset-5 text-custom-neutral-950 dark:text-custom-neutral-200">
              {description}
            </p>
          </div>
        </div>
        ...
        <div className="flex gap-150 px-200 py-150 justify-end">
          {/* secondary button */}
          <button
            className="bg-custom-neutral-100 dark:bg-custom-neutral-500 text-custom-neutral-600 dark:text-custom-neutral-200 px-200 py-150 rounded-8 text-preset-4 hover:bg-transparent border border-transparent hover:border-custom-neutral-300 focus:border-custom-neutral-950 dark:focus:border-white focus:outline outline-offset-2 outline-2 outline-custom-neutral-400"
            onClick={resetModal}
          >
            Cancel
          </button>
          ...
          {/* primary button */}
          <button
            className={`w-[117px] bg-${buttonColor} px-200 py-150 rounded-8 text-preset-4 text-white focus:outline outline-offset-2 outline-2 outline-custom-neutral-400`}
            onClick={() => {
              onSubmit();
              resetModal();
            }}
